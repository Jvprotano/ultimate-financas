    ...
    >
      <div className="space-y-4">
        ...
        {totalDeductions > 0 && (
          <div className="space-y-2">
            {benefitDeductions > 0 && (
              <div className="flex items-center justify-between px-3 py-2.5 bg-amber-500/10 rounded-lg border border-amber-500/20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="flex items-center justify-between px-3 py-2.5 bg-sky-500/10 rounded-lg border border-sky-500/20">
            <span className="text-sm text-sky-400">Cai na conta</span>
            <span className="text-sm font-bold text-sky-400">
              {formatCurrency(paycheckInAccount)}
            </span>
          </div>
          <div className="flex items-center justify-between px-3 py-2.5 bg-primary-500/10 rounded-lg border border-primary-500/20">
